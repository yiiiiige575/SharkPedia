...
if (!class_exists('WPM2AWS_Settings')) {
    class WPM2AWS_Settings
    {
        ...
        private static function checkSimplyStaticPlugin() {
            ...
            if ($isActive === true) {
              self::$settingsErrors[] = 'Simply Static plugin is active on this site  which causes coflicts in migration. Please disable this plugin for the duration of the cloning process.';  
            }
            return $isActive;
        }
